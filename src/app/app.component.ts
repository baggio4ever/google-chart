...
export class AppComponent {
  title = 'Google Charts コラボレーション';

  public pie_ChartData0 = [ ['Task', 'Hours per Day'], ['Work', 11], ['Eat', 2], ['Commute', 2], ['Watch TV', 2], ['Sleep', 7] ];

  public pie_ChartOptions0 = { title: 'My Daily Activities', width: 400, height: 400 };
